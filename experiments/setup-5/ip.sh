...
replica2_name=ec2-44-204-33-0.compute-1.amazonaws.com
replica2=${user_name}@${replica2_name}

replica3_name=ec2-34-240-78-166.eu-west-1.compute.amazonaws.com
replica3=${user_name}@${replica3_name}

replica4_name=ec2-3-109-153-92.ap-south-1.compute.amazonaws.com
...
client2_name=ec2-3-82-205-206.compute-1.amazonaws.com
client2=${user_name}@${client2_name}

client3_name=ec2-34-243-185-116.eu-west-1.compute.amazonaws.com
client3=${user_name}@${client3_name}

client4_name=ec2-52-66-246-21.ap-south-1.compute.amazonaws.com
...
replica2_ip="44.204.33.0"
replica3_ip="34.240.78.166"
replica4_ip="3.109.153.92"
replica5_ip="54.251.150.217"

client1_ip="13.211.188.163"
client2_ip="3.82.205.206"
client3_ip="34.243.185.116"
client4_ip="52.66.246.21"
