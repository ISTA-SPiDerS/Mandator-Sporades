...
broadcastMode=1 # 1 or 2
asyncTimeEpochSize=500
viewTimeout=500000000
...
output_path="${pwd}/experiments/${scenario}/logs/mandator/${arrival}/${keySize}/${iteration}/"
...
nohup sshpass ssh -o "StrictHostKeyChecking no" -i ${cert} ${client1} ".${remote_ctl_path}  --arrivalRate ${arrival} --batchSize ${clientBatchSize} --batchTime ${clientBatchTime} --config ${remote_config_path} --designatedReplica 1 --logFilePath ${remote_log_path} --name 21  --requestType request --window ${clientWindow} --keyLen ${keySize} " >${output_path}21.log &
nohup sshpass ssh -o "StrictHostKeyChecking no" -i ${cert} ${client2} ".${remote_ctl_path}  --arrivalRate ${arrival} --batchSize ${clientBatchSize} --batchTime ${clientBatchTime} --config ${remote_config_path} --designatedReplica 2 --logFilePath ${remote_log_path} --name 22  --requestType request --window ${clientWindow} --keyLen ${keySize} " >${output_path}22.log &
nohup sshpass ssh -o "StrictHostKeyChecking no" -i ${cert} ${client3} ".${remote_ctl_path}  --arrivalRate ${arrival} --batchSize ${clientBatchSize} --batchTime ${clientBatchTime} --config ${remote_config_path} --designatedReplica 3 --logFilePath ${remote_log_path} --name 23  --requestType request --window ${clientWindow} --keyLen ${keySize} " >${output_path}23.log &
nohup sshpass ssh -o "StrictHostKeyChecking no" -i ${cert} ${client4} ".${remote_ctl_path}  --arrivalRate ${arrival} --batchSize ${clientBatchSize} --batchTime ${clientBatchTime} --config ${remote_config_path} --designatedReplica 4 --logFilePath ${remote_log_path} --name 24  --requestType request --window ${clientWindow} --keyLen ${keySize} " >${output_path}24.log &
nohup sshpass ssh -o "StrictHostKeyChecking no" -i ${cert} ${client5} ".${remote_ctl_path}  --arrivalRate ${arrival} --batchSize ${clientBatchSize} --batchTime ${clientBatchTime} --config ${remote_config_path} --designatedReplica 5 --logFilePath ${remote_log_path} --name 25  --requestType request --window ${clientWindow} --keyLen ${keySize} " >${output_path}25.log &
