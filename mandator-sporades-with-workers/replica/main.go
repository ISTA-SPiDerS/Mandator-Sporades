...
func main() {
	name := flag.Int64("name", 5, "name of the replica as specified in the configuration.yml")
	...
	rp := src.New(int32(*name), cfg, mapCfg, *logFilePath, *batchSize, *batchTime, *debugOn, *mode, *debugLevel, *viewTimeout, *window, *asyncBatchTime, *consAlgo, *benchmarkMode, *keyLen, *valLen)
